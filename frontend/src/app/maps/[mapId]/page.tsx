      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="grid gap-6 lg:grid-cols-[1fr_360px]">
          ...
          <aside className="space-y-6">
            ...
            <section className="rounded-3xl border border-zinc-800 bg-zinc-900 p-6 shadow-2xl">
              <h2 className="text-xl font-black">Combate</h2>

              <p className="mt-2 text-sm text-zinc-400">
                Próximamente: iniciar combate con los personajes seleccionados.
              </p>

              <button
                type="button"
                disabled
                className="mt-4 w-full cursor-not-allowed rounded-xl bg-zinc-700 px-4 py-3 font-bold text-zinc-400"
              >
                Iniciar combate
              </button>
            </section>
